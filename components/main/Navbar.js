...
const Navbar = () => {
  ...
  return (
    <div className=" flex text-white w-full h-[80px] fixed top-0 z-50 md:justify-between items-center backdrop-blur-md p-11">
        <h1 className=" font-light text-gray-400 text-2xl md:px-0 md:py-5 cursor-pointer px-0 titlep"><span className="md:hidden" style={{marginRight: '80px' }}></span>PORTFOLIO</h1>
